                        ...
                        <div className="flex gap-4 flex-col pt-8">
                            <div className="form-control">
                                ...
                                <label className="input-group">
                                    <input type="text" placeholder="ชื่อ" className="input input-bordered w-full max-w-xs" defaultValue={newOrders?.name} onChange={(ev) => editNewOrder({ name: ev.target.value })} />
                                </label>
                            </div>
                            <div className="form-control">
                                <label className="label">
                                ...
                                <label className="input-group">
                                    <input type="text" placeholder="123" className="input input-bordered w-full max-w-xs" maxLength={3} defaultValue={newOrders?.number} onChange={(ev) => editNewOrder({ number: ev.target.value })} />
                                </label>
                            </div>
                            <div className="form-control">
                                <label className="label">
                                ...
                                <label className="input-group">
                                    <span>จำนวน</span>
                                    <input type="number" placeholder="123" className="input input-bordered w-full max-w-xs text-center" defaultValue={newOrders?.price} step={10} min={0} onChange={(ev) => editNewOrder({ price: parseInt(ev.target.value) })} />
                                    <span>THB</span>
                                </label>
                            </div>
